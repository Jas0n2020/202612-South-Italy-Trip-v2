...
<span style="display: flex; flex-direction: column; justify-content: center; text-align: left; min-width: 130px;">
  ...
  <span class="day-title" style="font-family: inherit; margin-left: 10px;">${escapeHtml(day.title)}</span>
  ${ticketSummary}
